...
\UnaryInfC{$\sgg \vdash c_\ell : \constrtype{\Sigma}{c_\ell}{\overline{s_i}}$}
\DisplayProof
...
\begin{tabular}{c c}
\hspace{-2em}
\AxiomC{$t_k \approx \Pi \Delta_{k_1} . \Pi x_k : I_k^{\upsilon_k}\ \overline{a}_k. \Pi \Delta_{k_2}. u_k \qquad \|\Delta_k\| = n_m - 1$}
\noLine
\UnaryInfC{$\upsilon_k \pos \Delta_{k_1}, \Delta_{k_2}, u_k \qquad \upsilon_k \notin \SV{\Gamma, \Delta_k, \overline{a}_k, e_k} \qquad \upsilon_k, \lfloor s \rfloor \in \mathcal{P}$}
\noLine
